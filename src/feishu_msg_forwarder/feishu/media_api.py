...
class MediaApi:
    ...
    def upload_image_from_path(self, user_access_token: str, file_path: str) -> str:
    ...
    def upload_file_from_path(self, user_access_token: str, file_path: str, file_name: str | None = None) -> str:
    ...
    def upload_image_from_base64(self, user_access_token: str, payload_b64: str, file_name: str = "image.bin") -> str:
        with _MaterializedTempFile(payload_b64, file_name) as file_path:
            return self.upload_image_from_path(user_access_token, file_path)

    def upload_file_from_base64(self, user_access_token: str, payload_b64: str, file_name: str) -> str:
        with _MaterializedTempFile(payload_b64, file_name) as file_path:
            return self.upload_file_from_path(user_access_token, file_path, file_name=file_name)
